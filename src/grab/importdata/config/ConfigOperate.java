...
public class ConfigOperate {
	private final static String areaPath = "/root/BGD/config/getServicesSuportArea.json";
	private final static String cityNumPath = "/root/BGD/config/cityNum.json";
	private final static String provinceNumPath = "/root/BGD/config/province_data.json";
